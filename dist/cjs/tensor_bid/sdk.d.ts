...
import { AcctDiscHexMap, AuthorizationData, Cluster, ParsedAnchorIx } from "@tensor-hq/tensor-common";
...
export declare class TensorBidSDK {
    ...
    takeBid({ bidder, seller, nftMint, lamports, margin, metaCreators, nftSellerAcc, authData, compute, priorityMicroLamports, optionalRoyaltyPct, takerBroker, }: {
        bidder: PublicKey;
        seller: PublicKey;
        nftMint: PublicKey;
        lamports: BN;
